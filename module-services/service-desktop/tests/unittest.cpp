...
TEST_CASE("FileContext UT Test Valid Input")
{
    ...
    {
        auto fileCtx = FileReadContext(filePath, fileSize, fileOffset, chunkSize);
...
TEST_CASE("FileContext UT Test Invalid Input")
{
    ...
    SECTION("Create file context for file with invalid file size")
    {
        ...
        REQUIRE_THROWS_WITH(FileReadContext(filePath, fileSize, fileOffset, chunkSize),
                            "Invalid FileContext arguments");
    }
