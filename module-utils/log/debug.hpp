...
#define DEBUG_GUI_TEXT               1 /// show basic debug messages for gui::Text - warning this can be hard on cpu
#define DEBUG_GUI_TEXT_LINES         1 /// show extended debug messages for gui::Text - lines building
#define DEBUG_GUI_TEXT_CURSOR        1 /// show extended debug messages for gui::Text - cursor handling
