...
namespace gui
{
    ...
    {
        header->navigationIndicatorAdd(header::NavigationIndicator::Ice);
    }
    ...
    void LockInputWindow::setTitleBar(bool titleVisible, bool iceVisible)
    {
        ...
        if (iceVisible) {
            ...
            header->navigationIndicatorRemove(header::NavigationIndicator::Ice);
        }
    }
    ...
    {
        return header->navigationIndicatorVisible(header::NavigationIndicator::Ice);
    }
