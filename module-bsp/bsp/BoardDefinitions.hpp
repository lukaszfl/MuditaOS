...
enum class BoardDefinitions
{
    ...
    BACKLIGHT_DRIVER_I2C_BAUDRATE = AUDIOCODEC_I2C_BAUDRATE,
    BACKLIGHT_DRIVER_I2C = AUDIOCODEC_I2C,
    BACKLIGHT_DRIVER_GPIO = static_cast<int>(drivers::GPIOInstances::GPIO_1),
    BACKLIGHT_DRIVER_NRST = 3, // GPIO_AD_B0_03 Active HIGH. External pulldown resistor of 10Ω between NRST and GND.
